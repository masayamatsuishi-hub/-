 ...
 * 「試合」は練習より運動強度が高く持続時間も長くなりやすいことを踏まえた目安値。
 */
export const TRAINING_MENUS: Record<string, TrainingMenuItem[]> = {
  陸上競技: [
    ...
    { id: 'track-match', name: '試合(公式レース)', mets: 13.0 },
  ],
  サッカー: [
    ...
    { id: 'soccer-scrimmage', name: '紅白戦(練習)', mets: 9.0 },
    { id: 'soccer-run', name: '走り込み(ランニングトレーニング)', mets: 8.0 },
    { id: 'soccer-match', name: '試合(公式戦)', mets: 10.5 },
  ],
  バスケットボール: [
    ...
    { id: 'bball-match', name: '試合(公式戦)', mets: 9.0 },
  ],
  野球: [
    ...
    { id: 'baseball-match', name: '試合(公式戦)', mets: 5.0 },
  ],
  ラグビー: [
    { id: 'rugby-pass', name: 'パス練習', mets: 4.0 },
    { id: 'rugby-contact', name: 'コンタクト練習', mets: 7.0 },
    { id: 'rugby-run', name: 'ランニングトレーニング', mets: 8.0 },
    { id: 'rugby-scrimmage', name: '紅白戦(練習)', mets: 9.0 },
    { id: 'rugby-match', name: '試合(公式戦)', mets: 10.5 },
  ],
  水泳: [
  ...
  その他: [
    ...
    { id: 'general-match', name: '試合', mets: 8.0 },
  ],
}
